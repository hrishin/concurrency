...
# Problem: 
Print numbers in sequnce from 0-N in sequnce and perform addition of numbers from 0-N/2. One thread prints Even numbers other one prints Odd numbers and last one add the number in current iteration.
